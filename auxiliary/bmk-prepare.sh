...
itap_args=" --s3_input=s3a://purdue-fsdump-bucket/itap/1m --agg_file=itap.agg2.csv "
...
nersc_args=" --s3_input=s3a://nersc-fsdump-bucket/1mgen2 --agg_file=nersc.agg2.csv --prefix_min=0 --prefix_max=5 "
...
hpss_args=" --s3_input=s3a://purdue-fsdump-bucket/hpss/1m --agg_file=hpss.agg2.csv "
